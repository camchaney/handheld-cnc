...
uint16_t TMC2660Stepper::cs2rms(uint8_t CS) {
  return (float)(CS+1)/32.0f * (vsense() ? 0.165f : 0.310f)/(Rsense+0.02f) / 1.41421f * 1000.0f;
}
...
void TMC2660Stepper::rms_current(uint16_t mA) {
  uint8_t CS = 32.0f*1.41421f*mA/1000.0f*Rsense/0.310f - 1;
  // If Current Scale is too low, turn on high sensitivity R_sense and calculate again
  if (CS < 16) {
    vsense(true);
    CS = 32.0f*1.41421f*mA/1000.0f*Rsense/0.165f - 1;
